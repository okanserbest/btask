...
const ContentBoxHero = ({ title, description, image, shape }: Props) => {
  return (
    <div className="relative flex flex-col overflow-hidden">
      ...
      <div className="mt-4 text-xl text-center lg:text-left text-midnightBlue font-medium leading-6 whitespace-nowrap z-10">
        {title}
      </div>
      <div className="mt-4 text-lg text-center lg:text-left text-midnightBlue leading-7 z-10">
        {description}
      </div>
    </div>
  );
