    ...
    <div className="bg-amber-900 w-full">
      <div className="max-w-1440 mx-auto relative px-20">
        ...
        <div className="absolute flex flex-col items-center justify-center self-stretch font-extrabold text-center text-amber-50 leading-[110%] z-10 top-0 right-0 bottom-0 left-0">
          <div className="text-8xl max-md:text-4xl">11,658,467</div>
          <div className="mt-2 text-6xl max-md:text-4xl">Shoes Collected</div>
        </div>

        <div className="absolute flex flex-col  z-10 top-0 right-0 bottom-0 left-0">
          <div className="absolute flex flex-col left-32  -top-3 items-center">
            <Image
              src={mapProduct}
              alt="mapProduct"
              loading="lazy"
